...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "w-full" }, [
      _c(
        "section",
        { staticClass: "h-screen w-full relative overflow-hidden" },
        [
          _c("div", {
            staticClass:
              "absolute top-1/2 h-1/2 left-0 w-full bg-gradient-to-b from-transparent z-40 to-gray-100"
          })
        ]
      ),
      _vm._v(" "),
      _c("section", { staticClass: "h-screen w-full" })
    ])
  }
]
